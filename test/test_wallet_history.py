...
import payrobot
from payrobot.models.wallet_history import WalletHistory  # noqa: E501
from payrobot.rest import ApiException

class TestWalletHistory(unittest.TestCase):
    """WalletHistory unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = payrobot.models.wallet_history.WalletHistory()  # noqa: E501
        if include_optional :
            return WalletHistory(
                currency = 'BTC', 
                wallet_id = '698fd3f6-5482-4798-8a46-6732af440616', 
                transactions = [
                    payrobot.models.wallet_transaction.WalletTransaction(
                        amount = '0.01', 
                        addresses = [
